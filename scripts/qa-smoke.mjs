...
const checks = [
  ...
  ['tts_backend_final_path', proxySource.includes('/api/tts/elevenlabs') && proxySource.includes('/api/tts/openai') && proxySource.includes('/api/tts/cartesia') && source.includes('browser/system speech is fallback-only') || source.includes('API voice uses backend endpoints')],
